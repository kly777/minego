...
func PhysicalMouseClick(x, y int32) {
	// 获取虚拟桌面范围
	virtLeft := GetSystemMetrics(SM_XVIRTUALSCREEN)
	virtTop := GetSystemMetrics(SM_YVIRTUALSCREEN)
